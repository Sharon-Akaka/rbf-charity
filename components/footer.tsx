      ...
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 border-t border-border pt-8">
          <div className="flex flex-col items-start gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <p className="max-w-2xl text-xs leading-relaxed text-muted-foreground">
              The RBF is not a registered charity. It is an internal support
              initiative under the Sierra Leone Grammar School Old Boys&apos;
              Association Foundation Trust (UK). Contributions do not qualify
              for tax relief.{" "}
              <button
                type="button"
        ...
        <div className="mt-6 border-t border-border pt-6">
          <p className="text-center text-sm text-muted-foreground">
            © {new Date().getFullYear()} The Regentonians&apos; Benevolent Fund.
            All rights reserved.
          </p>
        </div>
      </div>
